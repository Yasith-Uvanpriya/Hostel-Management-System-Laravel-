    ...
    <div class="container mt-5">
        ...
        <form action="/add-room" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="1" class="form-control" id="bedCount" name="number_of_beds" value="{{ old('bedCount') }}" required placeholder="Enter bed count">
            </div>

            <div class="mb-3">
                <label for="lockerCount" class="form-label">Locker Count</label>
                <input type="number" min="0" class="form-control" id="lockerCount" name="locker_number" value="{{ old('lockerCount') }}" required placeholder="Enter locker count">
